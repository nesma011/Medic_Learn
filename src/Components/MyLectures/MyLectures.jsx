  ...
  return (
    <div className="flex-col">
      ...
      <div className="p-6 text-center">
        <h1 className="text-3xl font-bold text-green-800">My lectures</h1>
        {loading ? (
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 mt-4">
            {lectures.map((lecture) => (
              <div key={lecture.lecture__id} className="bg-white shadow-md rounded-lg p-4">
                ...
                <h2 className="text-xl font-semibold text-green-700 mt-3">{lecture.lecture__title}</h2>
            ...
            className="mt-3 ml-3 inline-block bg-green-600 text-white py-2 px-4 rounded-lg hover:bg-green-700 transition"
                >
            Watch Lecture
           </button>
              </div>
