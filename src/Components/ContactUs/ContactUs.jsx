...
export default function ContactUs() {
  ...
  return (
    <>
      ...
      <div className="max-w-lg mx-auto bg-gradient-to-r from-green-600 mb-20 to-gray-500 shadow-xl rounded-3xl p-8 mt-10 text-white relative overflow-hidden">
        ...
        <div className="space-y-6 relative z-10">
          {contact ? (
            <>
              ...
              <div className="flex items-center space-x-4 bg-white bg-opacity-20 p-3 rounded-lg hover:bg-opacity-30 transition">
                <FaTelegramPlane className="text-green-300 text-xl" />
            ...
            <p className="text-center text-lg">No contact data available at the moment.</p>
          )}
        </div>
      </div>
      <Footer />
